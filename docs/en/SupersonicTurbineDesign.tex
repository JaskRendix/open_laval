...
These define the amount of expansion on each surface, which must individually satisfy 
$\nu_{\min} \le \nu_{l} < \nu_{u} \le \nu_{\max}$.
...
OpenLaval validates all angles to ensure they lie within the physically
admissible Prandtl–Meyer span defined by inlet and outlet conditions.
